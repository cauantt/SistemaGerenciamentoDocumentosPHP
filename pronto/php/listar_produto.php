...
<body>
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        mysqli_select_db($conexao, "bd_resolv");
                            ...
                            // Fazendo a seleção da tabela tb_produto
                        ...
                        while($linha = mysqli_fetch_array($resultado)) {
                            ...
                            ?>
                            <!-- Início Modal -->
                            <!-- Verificação dentro do loop PHP para cada produto -->
    ...
    <!-- Scripts necessários para o Bootstrap funcionar -->
    ...
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0-beta.2/js/bootstrap.min.js" integrity="sha384-alpBpkdN7fM3k1y6U6sF6pD6w5Ohb5A5qjZQb7VqE5jnlWWS6G3e6o5e5LPu5v6c" crossorigin="anonymous">
